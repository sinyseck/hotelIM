        ...
        <form action="{{ route('tarifs.store') }}" method="POST">
            @csrf
             <div class="card border-danger border-0">
                        <div class="card-header bg-info text-center">FORMULAIRE D'ENREGISTREMENT D'UN NOUVEAU TARIF</div>
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="number" name="nbre_personne" class="form-control" min="1" required>
                                    </div>
                                </div>
