                        ...
                        @foreach ($hotels as $hotel)
                            <tr>
                                ...
                                <td>
                                    ...
                                    {!! Form::open(['method' => 'DELETE', 'route'=>['hotels.destroy', $hotel->id], 'style'=> 'display:inline', 'onclick'=>"if(!confirm('Êtes-vous sûr de vouloir supprimer cet enregistrement ?')) { return false; }"]) !!}
